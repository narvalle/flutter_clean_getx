...
class GetNumberTriviaFromNumber implements UseCase<NumberTrivia, Params>{
  ...
  GetNumberTriviaFromNumber(this._repository);
  
  @override
  Future<Either<Failure, NumberTrivia>> call(Params params) async => await _repository.getNumberTriviaFromNumber(params.number);
